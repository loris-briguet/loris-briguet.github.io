class Letter17 {
  ...
  draw() {
    ...
    //blue line
    c.beginPath();
    c.moveTo(this.w / 2 - this.r, this.h / 2 + (this.r + this.semR)- Math.abs(Math.sin(this.speed)) * (this.r));
    c.lineTo(this.w / 2 + this.r, this.h / 2 + (this.r + this.semR)- Math.abs(Math.sin(this.speed)) * (this.r));
    ...
    c.beginPath();
    c.arc(
      this.w / 2 - Math.abs(Math.sin(this.speed) * this.semR),
      this.h / 2 - (this.r + this.semR) - Math.abs(Math.sin(this.speed)) * this.semR + this.r,
      this.r - Math.abs(Math.sin(this.speed)) * this.semR,
      0, Math.PI * 2, false);
    ...
    //black line
    c.beginPath();
    c.moveTo(this.w / 2 - this.r, this.h / 2 + (this.semR) - this.stroke / 2);
