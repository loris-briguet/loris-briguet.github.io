class Letter5 {
  ...
  draw() {
    ...
    c.arc(
      ...
      this.h / 2 + this.semR,
      this.r,
      -Math.PI / 2, -Math.PI - Math.abs(Math.sin(this.speed)) * (Math.PI * 1.5), false);
    ...
    c.arc(
      this.w / 2,
      this.h / 2 - (this.r + this.semR) + Math.abs(Math.sin(this.speed)) * (this.r*2) ,
      this.r,
      Math.PI/2, Math.PI, false);

      c.moveTo(this.w / 2 - this.r, this.h / 2 - (this.r + this.semR));
      c.lineTo(this.w / 2- this.r, this.h / 2 - (this.r + this.semR) + Math.abs(Math.sin(this.speed)) * (this.r*2));
    ...
    //black Part
    c.beginPath();
    c.moveTo(this.w / 2 - this.r - this.stroke/2, this.h / 2 - (this.r + this.semR) );
    c.lineTo(this.w / 2, this.h / 2 - (this.r + this.semR));
