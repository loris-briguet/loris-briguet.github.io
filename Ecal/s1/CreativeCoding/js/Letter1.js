class Letter1 {
  ...
  draw() {
    ...
    c.beginPath();
    c.moveTo(this.w / 2 - this.r, this.h / 2 - this.semR);
    ...
    c.arc(
      ...
      this.h / 2 + Math.abs(Math.sin(this.speed)) * this.semR - this.r,
    ...
    c.beginPath();
    c.arc(this.w / 2 + Math.abs(Math.sin(this.speed)) * this.r, this.h / 2 + this.semR, this.r, -Math.PI / 2, 0, false);

    c.moveTo(this.w / 2 + this.r + Math.abs(Math.sin(this.speed)) * this.r, this.h / 2 + this.semR);
    c.lineTo(this.w / 2 + this.r + Math.abs(Math.sin(this.speed)) * this.r, this.h / 2 + (this.r + this.semR + this.stroke / 2));

    c.moveTo(this.w / 2, this.h / 2 - this.semR);
    c.lineTo(this.w / 2 + Math.abs(Math.sin(this.speed)) * this.r, this.h / 2 - this.semR);
  ...
  key_a() {
    this.i = Math.floor(Math.random() * (this.col1g.length - 1) + 1)
    this.j = Math.floor(Math.random() * (this.col1g.length - 1) + 1)
    this.col1r[this.i]
    this.col1g[this.i]
    this.col1b[this.i]
    this.col1 = 'rgb(' + this.col1r[this.i] + ',' + this.col1g[this.i] + ',' + this.col1b[this.i] + ')';
