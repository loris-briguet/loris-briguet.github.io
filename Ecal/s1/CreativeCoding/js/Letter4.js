class Letter4 {
  ...
  draw() {
    ...
    //red Part
    c.beginPath();
    c.arc(this.w / 2 + Math.abs(Math.sin(this.speed)) * this.r - this.stroke/2, this.h / 2 - (this.r + this.semR), this.r, 0, Math.PI / 2, false);
    ...
    c.lineTo(this.w / 2 + this.r + Math.abs(Math.sin(this.speed)) * this.r, this.h / 2 - (this.r + this.semR));
