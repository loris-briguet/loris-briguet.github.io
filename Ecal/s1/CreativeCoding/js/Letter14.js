class Letter14 {
  ...
  draw() {
    ...
    //red line
    c.beginPath();
    c.arc(this.w / 2, this.h / 2 + (this.semR) - Math.abs(Math.sin(this.speed)) * this.r, this.r, -Math.PI / 2, 0, false);
    c.moveTo(this.w / 2 + this.r, this.h / 2 + this.semR - Math.abs(Math.sin(this.speed)) * this.r);
    c.lineTo(this.w / 2 + this.r, this.h / 2 + this.semR + this.r + this.stroke / 2);
    ...
    //blue line
    c.beginPath();
    c.arc(this.w / 2, this.h / 2 - (this.semR) + Math.abs(Math.sin(this.speed)) * this.r, this.r, Math.PI / 2, -Math.PI, false);
    c.moveTo(this.w / 2 - this.r, this.h / 2 - (this.semR + this.r + this.stroke / 2));
    c.lineTo(this.w / 2 - this.r, this.h / 2 - this.semR + Math.abs(Math.sin(this.speed)) * this.r);
    ...
    c.beginPath();
    c.moveTo(this.w / 2, this.h / 2 - (this.r + this.semR) - this.stroke / 2);
