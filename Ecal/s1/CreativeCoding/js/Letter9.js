class Letter9 {
  ...
  draw() {
    ...
    //red Part
    c.beginPath();
    c.arc(this.w / 2, this.h / 2 - this.semR + Math.abs(Math.sin(this.speed)) * this.r * 2, this.r, Math.PI, -Math.PI / 2, false);

    c.moveTo(this.w / 2 - this.r, this.h / 2 - this.semR + Math.abs(Math.sin(this.speed)) * this.r * 2);
    ...
    //blue Part
    c.beginPath();
    c.arc(this.w / 2 + this.r, this.h / 2 - this.semR, this.r, Math.PI, -Math.PI / 2, false);

    c.moveTo(this.w / 2, this.h / 2 - this.semR - this.stroke / 2);
    c.moveTo(this.w / 2, this.h / 2 - this.semR - Math.abs(Math.sin(this.speed)) * this.r * 2 + this.stroke / 2);

    c.moveTo(this.w / 2 + this.r, this.h / 2 - (this.r + this.semR) - this.stroke / 2);
    c.lineTo(this.w / 2 + this.r, this.h / 2 + (this.r + this.semR) - Math.abs(Math.sin(this.speed)) * this.r * 2 + this.stroke / 2);
