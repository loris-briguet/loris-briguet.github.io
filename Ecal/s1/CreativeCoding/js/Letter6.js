class Letter6 {
  ...
  draw() {
    ...
    //black Part
    c.beginPath();
    c.arc(this.w / 2, this.h / 2 - (this.r + this.semR), this.r, 0, Math.PI / 2, false);


    c.moveTo(this.w / 2, this.h / 2 - (this.r + this.semR));
    c.lineTo(this.w / 2 + this.r + this.stroke / 2, this.h / 2 - (this.r + this.semR));
