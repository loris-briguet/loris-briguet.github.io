class Letter18 {
  ...
  draw() {
    ...
    //blue line
    c.beginPath();
    c.moveTo(this.w / 2 + this.r - Math.abs(Math.sin(this.speed)) * this.r * 2, this.h / 2 - (this.semR) - this.stroke / 2);
    c.lineTo(this.w / 2 + this.r - Math.abs(Math.sin(this.speed)) * this.r * 2, this.h / 2 + (this.r + this.semR) + this.stroke / 2);
