class Letter13 {
  ...
  draw() {
    ...
    c.lineTo(this.w / 2 + Math.abs(Math.sin(this.speed)) * this.r, this.h / 2 + this.semR + Math.abs(Math.sin(this.speed)) * this.r);
   ...
   //black line
    ...
    c.arc(
      ...
      this.h / 2 - this.semR,
      this.r,
      -Math.PI + Math.abs(Math.sin(this.speed)) * Math.PI * 2, 0 + Math.abs(Math.sin(this.speed)) * Math.PI * 2, false);
