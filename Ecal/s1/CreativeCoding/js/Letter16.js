class Letter16 {
  ...
  draw() {
    ...
    c.arc(
      ...
      this.h / 2 - (this.semR) + Math.abs(Math.sin(this.speed)) * (this.r),
      this.r + Math.abs(Math.sin(this.speed)) * (this.r),
      Math.PI, -Math.PI / 2, false);
    c.moveTo(this.w / 2 + this.r + Math.abs(Math.sin(this.speed)) * (this.r), this.h / 2 - (this.r + this.semR) - this.stroke / 2);
    c.lineTo(this.w / 2 + this.r + Math.abs(Math.sin(this.speed)) * (this.r), this.h / 2 + (this.r + this.semR) + this.stroke / 2);
    ...
    //red line
    c.beginPath();
    c.arc(this.w / 2 - this.r, this.h / 2 - (this.semR) + Math.abs(Math.sin(this.speed)) * this.semR, this.r, -Math.PI / 2, 0, false);
    // c.moveTo(this.w / 2 , this.h / 2 + this.semR - Math.abs(Math.sin(this.speed)) * this.r);
    // c.lineTo(this.w / 2 , this.h / 2);
    c.arc(this.w / 2 - this.r, this.h / 2 + (this.semR) - Math.abs(Math.sin(this.speed)) * this.semR, this.r, 0, Math.PI / 2, false);
    ...
    c.beginPath();
    c.moveTo(this.w / 2 - this.r, this.h / 2 - (this.r + this.semR) - this.stroke / 2);
    c.lineTo(this.w / 2 - this.r, this.h / 2 + (this.r + this.semR) + this.stroke / 2);
