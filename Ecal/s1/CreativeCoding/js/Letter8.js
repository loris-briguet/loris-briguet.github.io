class Letter8 {
  ...
  draw() {
    ...
    c.moveTo(this.w / 2 + this.r, ((this.h / 2 - this.semR) -this.stroke/2) - Math.abs(Math.sin(this.speed)) * this.r);
    c.lineTo(this.w / 2 + this.r, this.h / 2 + this.semR);
    c.arc(this.w / 2, this.h / 2 + (this.semR), this.r, 0, Math.PI / 2, false);
    ...
    c.beginPath();
    c.moveTo(this.w / 2, this.h / 2 - this.semR + Math.abs(Math.sin(this.speed)) * this.r * 2);
    c.lineTo(this.w / 2, this.h / 2 + (this.r + this.semR) + this.stroke / 2);
    c.moveTo(this.w / 2 - this.r, this.h / 2 - this.semR + Math.abs(Math.sin(this.speed)) * ((this.r * 2) - this.stroke / 2));
    c.lineTo(this.w / 2 + this.stroke / 2, this.h / 2 - this.semR + Math.abs(Math.sin(this.speed)) * ((this.r * 2) - this.stroke / 2));
    ...
    c.beginPath();
    c.moveTo(this.w / 2 - this.r, this.h / 2 - (this.r + this.semR));
