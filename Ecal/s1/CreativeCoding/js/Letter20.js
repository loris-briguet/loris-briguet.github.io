class Letter20 {
  ...
  draw() {
    ...
    //red line
    c.beginPath();
    c.moveTo(this.w / 2 - this.r, this.h / 2 - (this.r) + Math.abs(Math.sin(this.speed)) * (this.r + this.semR));
    c.lineTo(this.w / 2 + this.r + this.stroke / 2, this.h / 2 - (this.r) + Math.abs(Math.sin(this.speed)) * (this.r + this.semR));
    ...
    //black line
    c.beginPath();
    c.moveTo(this.w / 2 - this.r, this.h / 2 - (this.semR + this.r));
    ...
    c.arc(
      ...
      this.h / 2 + this.semR,
      this.r,
      0 + Math.abs(Math.sin(this.speed)) * Math.PI * 2, -Math.PI + Math.abs(Math.sin(this.speed)) * Math.PI * 2, false);
