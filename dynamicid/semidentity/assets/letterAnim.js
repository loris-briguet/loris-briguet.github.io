class Letter {
    ...
    constructor(options) {
        ...
        this.r = 36;
        this.rR = sin( (frameCount + 1)  ) * random(20, 40);
    ...
    drawBlobs(layer) {
        layer.push();
        this.rR = (sin( (frameCount) /10 )+ 3) * 10
    ...
    draw_M(layer) {
        ...
        layer.ellipse(36, 18, (sin( (frameCount + 444) /18 )+ 3) * 10)
        layer.ellipse(58, 59, (sin( (frameCount + 5) /11 )+ 3) * 10)
        layer.ellipse(81, 100, (sin( (frameCount + 286) /24 )+ 3) * 10)
        layer.ellipse(104, 59, (sin( (frameCount + 55) /9 )+ 3) * 10)
        layer.ellipse(126, 18, (sin( (frameCount - 49) /16 )+ 3) * 10)
    }
    rectDraw_M(layer) {
        translate(11,0)
        rect(0, 0, this.r, 200);
    ...
    draw_S(layer) {
        ...
        layer.ellipse(96, 18, (sin( (frameCount - 1000) /9 )+ 3) * 10)
        layer.ellipse(52, 18, (sin( (frameCount + 45) /18 )+ 3) * 10)
        layer.ellipse(18, 59, (sin( (frameCount - 480) /13 )+ 3) * 10)
        layer.ellipse(48, 100, (sin( (frameCount + 670) /20 )+ 3) * 10)
        layer.ellipse(88, 100, (sin( (frameCount +22 )/10 )+ 3) * 10)
        layer.ellipse(121, 141, (sin( (frameCount - 111) /30 )+ 3) * 10)
        layer.ellipse(84, 182, (sin( (frameCount + 333) /25 )+ 3) * 10)
        layer.ellipse(40, 182, (sin( (frameCount - 49) /16 )+ 3) * 10)
    }
    rectDraw_S(layer) {}
